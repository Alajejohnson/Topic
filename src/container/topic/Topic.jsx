      ...
      <div className="trending bg-[var(--section-bg-color)] px-6 py-10 lg:px-24 lg:py-24">
        ...
        <div className="hero__buttom__left w-fit ">
          ...
          <div className="badge  bg-[#536DFE]">
            ...
            <button className='text-sm lg:text-xl p-2 lg:p-4 rounded-full text-whitecolor bg-btnbgcolor hover:bg-btnbghovercolor font-semibold mt-2 lg:mt-8' >Learn More</button>
          </div>
