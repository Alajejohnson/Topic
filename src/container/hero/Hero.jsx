  ...
  return (
    <div className="hero" id='hero'>
      <div className="hero__top px-4 py-24 lg:px-0 ">
        ...
        <p className='w-fit text-base lg:text-2xl pt-4 '>platform for creatives around the world</p>
        <div className="hero__input__group w-full md:w-[70%] lg:w-3/6 py-2 lg:py-2 px-3   ">
        <Icon icon="simple-line-icons:magnifier" className='text-3xl lg:text-[50px] text-darkcolor ' />
          <input type="search" role='search' placeholder='Design, Code, Marketing, Finance ...' className='w-full lg:min-w-96   placeholder:text-xs placeholder:lg:text-xl ' />
          <button className='text-xs lg:text-2xl py-2 px-5 lg:py-2 lg:px-6 rounded-3xl '>search</button>
        </div>
      </div>
